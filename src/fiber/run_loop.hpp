...
class run_loop {
        ...
        struct __schedule_task {
          ...
          private:
            ...
            struct __env {
                ...
                template <class _CPO>
                auto query(stdexec::get_completion_scheduler_t<_CPO>)
                    const noexcept -> __scheduler {
          ...
          public:
            auto get_env() const noexcept -> __env { return __env{__loop_}; }
        };
  ...
  private:
    ...
    std::mutex __mutex_;
    fiber::condition_variable __cv_;
