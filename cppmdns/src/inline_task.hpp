...
namespace __detail{
    namespace __coro_alloc{
        ...
        class coro_alloc{
            ...
            static auto __dealloc_address(std::uintptr_t ptr, std::size_t size)noexcept{
            ...
            template<class Alloc>
            static auto __alloc_address(std::uintptr_t ptr, std::size_t size)noexcept{
            ...
            static void* __allocate(const Alloc& a, std::size_t size)noexcept{
                ...
                dealloc_fn d_fn = &__deallocator<rebind_a_t>;
        ...
        public:
            ...
            void operator delete(void *ptr, std::size_t size)noexcept{
                dealloc_fn d_fn = *__dealloc_address(reinterpret_cast<std::uintptr_t>(ptr), size);
                d_fn(ptr, size);
            }
        };
    } // namespace __coro_alloc
