...
template<class ...Args>
struct shared_promise
{
    static_assert((true && ... && std::is_copy_constructible_v<Args>));
    using operation_list_type = boost::intrusive::list<operation_base<Args...>, boost::intrusive::constant_time_size<false>>;
...
private:
    ...
    private:
        ...
        future(operation_list_type& ops):
            _ops{&ops}
        {}
        ...
        struct op_t final: public operation_base<Args...>{
            ...
            void set_value(const Args& ...args)noexcept override{
                if constexpr((true && ... && std::is_nothrow_copy_constructible_v<Args>)){
        ...
        struct cancelable_op_t final: public operation_base<Args...>{
            ...
            friend void tag_invoke(stdexec::start_t, cancelable_op_t& self)noexcept{
        ...
        private:
            ...
            using stop_callback_t = typename stdexec::stop_token_of_t<stdexec::env_of_t<R>&>:: template callback_type<on_stop_t>;
    ...
    public:
        template<stdexec::receiver R>
        friend stdexec::operation_state auto tag_invoke(stdexec::connect_t, future f, R&& r)noexcept{
            if constexpr(stdexec::unstoppable_token<stdexec::stop_token_of_t<stdexec::env_of_t<R>>>){
                ...
                return cancelable_op_t<std::decay_t<R>>{std::forward<R>(r), *f._ops};
            }
        }
    private:
        operation_list_type *_ops;
...
template<>
struct shared_promise<void>
{
    using operation_list_type = boost::intrusive::list<operation_base<void>, boost::intrusive::constant_time_size<false>>;
