...
#include "packet/error_cause/cookie_received_while_shutting_down_cause.h"
#include "packet/error_cause/invalid_mandatory_parameter_cause.h"
#include "packet/error_cause/invalid_stream_identifier_cause.h"
#include "packet/error_cause/missing_mandatory_parameter_cause.h"
#include "packet/error_cause/no_user_data_cause.h"
#include "packet/error_cause/out_of_resource_error_cause.h"
#include "packet/error_cause/protocol_violation_cause.h"
#include "packet/error_cause/restart_of_an_association_with_new_address_cause.h"
#include "packet/error_cause/stale_cookie_error_cause.h"
#include "packet/error_cause/unrecognized_chunk_type_cause.h"
#include "packet/error_cause/unrecognized_parameter_cause.h"
#include "packet/error_cause/unresolvable_address_cause.h"
#include "packet/error_cause/user_initiated_abort_cause.h"


namespace dcsctp {

template <class ErrorCause>
bool ParseAndPrint(ParameterDescriptor descriptor, std::ostringstream& sb) {
